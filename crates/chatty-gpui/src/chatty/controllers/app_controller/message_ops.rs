...
//!
//! This file is one of the `impl ChattyApp` extension modules under
...
//! - The `handle_stream_manager_event` dispatcher that turns `StreamManager`
//!   events into UI updates on `ChatView`.
//! - `finalize_completed_stream`, `finalize_stopped_stream`,
//!   `handle_feedback_changed`, `stop_stream`.
//!
//! # What does NOT live here
//!
//! - The actual streaming loop, attachment conversion, and Azure / auth
//!   helpers — those moved to `message_ops_internals.rs` (a private sibling
//!   module) to keep this file focused on the `ChattyApp` surface.
//! - Stream lifecycle primitives — `chatty::models::stream_manager`.
