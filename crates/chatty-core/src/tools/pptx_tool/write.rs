...
pub(super) fn build_shape_xml(shape_id: u32, shape: &PptxShapeSpec) -> Result<String, PptxToolError> {
    match shape {
...
pub(super) fn insert_shape_xml(slide_xml: &[u8], shape_xml: &str) -> Result<Vec<u8>, PptxToolError> {
