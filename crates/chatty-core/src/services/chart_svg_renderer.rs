...
use crate::tools::chart_tool::ChartSpec;
...
fn render_line_svg(spec: &ChartSpec, colors: &[&str; 5]) -> String {
    ...
    let data: std::borrow::Cow<[crate::tools::chart_tool::ChartDataPoint]> =
        if let Some(series) = &spec.series {
...
fn render_multi_line_svg(
    spec: &ChartSpec,
    series: &[crate::tools::chart_tool::SeriesData],
    colors: &[&str; 5],
) -> String {
...
mod tests {
    use super::*;
    use crate::tools::chart_tool::{CandlestickDataPoint, ChartDataPoint};
